...
namespace ServerInformations
{
    ...
    class ChatServer
    {
        ...
        public static void AddUser(TcpClient tcpUser, string strUsername)
        {
            ...
            SendAdminMessage(htConnections[tcpUser] + " Initialisé.!s");
        }
        ...
        public static void RemoveUser(TcpClient tcpUser)
        {
            ...
            if (htConnections[tcpUser] != null)
            {
                ...
                SendAdminMessage(htConnections[tcpUser] + " Fin de simulation..\n");
        ...
        public static void SendAdminMessage(string Message)
        {
            ...
            e = new StatusChangedEventArgs("Simulateur: " + Message);
            OnStatusChanged(e);
            ...
            for (int i = 0; i < tcpClients.Length; i++)
            {
                ...
                try
                {
                    ...
                    swSenderSender.WriteLine("Simulateur: " + Message);
